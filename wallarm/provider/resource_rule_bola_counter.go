...
func resourceWallarmBolaCounterCreate(_ context.Context, d *schema.ResourceData, m interface{}) diag.Diagnostics {
	client := apiClient(m)
	...
	return resourceWallarmBolaCounterRead(context.TODO(), d, m)
}
