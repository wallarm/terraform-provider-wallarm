...
func resourceWallarmVpatch() *schema.Resource {
	...
	return &schema.Resource{
		...
		UpdateContext: resourceWallarmVpatchUpdate,
...
// nolint:dupl
func resourceWallarmVpatchImport(_ context.Context, d *schema.ResourceData, _ interface{}) ([]*schema.ResourceData, error) {
