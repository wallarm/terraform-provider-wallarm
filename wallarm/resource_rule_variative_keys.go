...
func resourceWallarmVariativeKeys() *schema.Resource {
...
func resourceWallarmVariativeKeysCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceWallarmVariativeKeysRead(d, m)
}

func resourceWallarmVariativeKeysRead(d *schema.ResourceData, m interface{}) error {
	return resourcerule.ResourceRuleWallarmRead(d, retrieveClientID(d), m.(wallarm.API),
		common.ReadOptionWithPoint)
}

func resourceWallarmVariativeKeysDelete(d *schema.ResourceData, m interface{}) error {
	client := m.(wallarm.API)
	clientID := retrieveClientID(d)
...
func resourceWallarmVariativeKeysUpdate(d *schema.ResourceData, _ interface{}) error {
	log.Printf("[DEBUG] resourceWallarmVariativeKeysUpdate, action_id: %v\n", d.Get("action_id"))
	return nil
}
...
func resourceWallarmVariativeKeysImport(d *schema.ResourceData, _ interface{}) ([]*schema.ResourceData, error) {
	...
	if len(idAttr) == 3 {
		...
		d.Set("rule_type", "variative_keys")
